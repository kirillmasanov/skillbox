...
class Volatility(multiprocessing.Process):
    ...
    def run(self):
        ...
        self.collector.put(dict(file_name=self.file_name, volatility=self.volatility))
...
def main():
    ...
    volatilities = [Volatility(file_name=file, collector=collector) for file in file_list]
